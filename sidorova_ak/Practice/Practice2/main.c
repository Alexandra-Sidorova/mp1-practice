...
void main()
{
	...
	do {                                                                       // Пошел цикл на обработку вводного числа и его сравнения с задуманным
		do {
			f = i = k = 0;
			...
			{                                                                  // не совпадает с количеством цифр числа компьютера (Проверка)
				...
				{                                                              // Цикл в цикле, который тоже в цикле - нерационально, но как еще сделать проверку ввода на повторы, я тогда не знаю
					for (i = k + 1; i < n; i++)
					{
