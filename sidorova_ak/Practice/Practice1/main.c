...
void main()
{
	...
	if (d  > (r1 + r2))
	{
		printf("Окружности не пересекаются и не касаются, ни одна из окружностей не находится в другой.\n");
		return;
	}
	if (d == (r1 + r2))
	{
	...
	if (((d + r1) == r2) || ((d + r2) == r1))
	{
		printf("Окружности касаются, причем одна из окружностей внешне касается с другой, т.е. одна лежит внутри второй окружности.\n");
		return;
	}
	if ((d < (r1 - r2)) || (d < (r2 - r1)))
	{
